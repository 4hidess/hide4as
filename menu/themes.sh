...
function menu1 () {
clear
echo -e "${GREEN}Please enter the name of the menu banner"
...
echo -e "   \e[$line════════════════════════════════════════\e[m"
echo -e "   \e[$number (•1)\e[m ${RED} Red\e[m"
echo -e "   \e[$number (•2)\e[m ${GREEN} Green\e[m"
...
echo -e "   \e[$number (•1)\e[m ${RED} 3D ASCII\e[m"
echo -e ""
echo -e ""
figlet -f 3d "Premium"
echo -e "   \e[$number (•2)\e[m ${GREEN} 3d\e[m"
echo -e ""
echo -e ""
...
function menu10 () {
clear
echo -e "${GREEN}Please enter the name of provider"
...
echo -e "   \e[$line════════════════════════════════════════\e[m"
echo -e "   \e[$number (•1)\e[m ${RED} Youtube Style\e[m"
echo -e "   \e[$number (•2)\e[m \e[1;34m Facebook Style\e[m"
echo -e "   \e[$number (•3)\e[m ${GREEN} Whatsapp Style\e[m"
echo -e "   \e[$number (•4)\e[m \e[1;35m Squid Game Style\e[m"
echo -e "   \e[$number (•5)\e[m ${RED} Horror Style\e[m"
