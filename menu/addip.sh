...
adminip=$( curl -sS https://raw.githubusercontent.com/givpn/allow/main/adminipvps | grep $MYIP )
...
sleep 1
cek=$( curl -sS https://raw.githubusercontent.com/givpn/allow/main/ipvps.conf | awk '{print $5}' | grep $daftar )
if [[ $daftar = $cek ]]; then
echo -e "${RED} The IP VPS Has Been Registered${NC}"
sleep 2
exit
else
...
rm -rf /root/allow
git config --global user.email "givpn11@gmail.com"
git config --global user.name "givpn"
git clone https://github.com/givpn/allow.git
mkdir /root/allow
cd /root/allow/
rm -rf .git
git init
...
git branch -M main
git remote add origin https://github.com/givpn/allow.git
git push -f https://${tokengit}@github.com/givpn/allow.git
...
links3="sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl && wget https://raw.githubusercontent.com/givpn/hide4as/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh"

echo -e "\033[0;34m------------------------------------------\033[0m"
echo -e "\E[44;1;39m      Client IP VPS Add Successfully      ${NC}"
echo -e "\033[0;34m------------------------------------------\033[0m"
echo "  Ip VPS        : $daftar"
echo "  Order ID      : $id"
...
echo ""
echo -e "\033[0;34m------------------------------------------\033[0m"
echo -e "\E[44;1;39m               NOTA TAMBAHAN              ${NC}"
echo -e "\033[0;34m------------------------------------------\033[0m"
...
clear
echo -e "\033[0;34m------------------------------------------\033[0m"
echo -e "\E[44;1;39m       Delete User IP VPS Registered      ${NC}"
echo -e "\033[0;34m------------------------------------------\033[0m"
...
clear
echo -e "\033[0;34m------------------------------------------\033[0m"
echo -e "\E[44;1;39m      Client IP Deleted Successfully      ${NC}"
echo -e "\033[0;34m------------------------------------------\033[0m"
echo " Ip VPS       : $daftar"
echo " Order ID     : $id"
echo " Expired Date : $exp"
...
clear
echo -e "\033[0;34m------------------------------------------\033[0m"
echo -e "\E[44;1;39m       Renew User IP VPS Registered       ${NC}"
echo -e "\033[0;34m------------------------------------------\033[0m"
...
echo -e "IPVPS Registration Completed"
  clear
echo -e "\033[0;34m------------------------------------------\033[0m"
echo -e "\E[44;1;39m     Client IP VPS Renew Successfully     ${NC}"
echo -e "\033[0;34m------------------------------------------\033[0m"
echo "  Ip VPS        : $user"
echo "  Order ID      : $id"
echo "  Renew Date    : $now"
...
clear
echo -e "\033[0;34m------------------------------------------\033[0m"
echo -e "\E[44;1;39m        List User IP VPS Registered       ${NC}"
echo -e "\033[0;34m------------------------------------------\033[0m"
...
clear
echo -e "\033[0;34m------------------------------------------\033[0m"
echo -e "\E[44;1;39m         MENU ADD IP MULTIPORT WS         ${NC}"
echo -e "\033[0;34m------------------------------------------\033[0m"
echo ""
echo -e " [\e[36m 01 ${NC}] Add IP"
echo -e " [\e[36m 02 ${NC}] Delete IP"
echo -e " [\e[36m 03 ${NC}] Renew IP"
echo -e " [\e[36m 04 ${NC}] Check User IP"
echo -e " [\e[36m 05 ${NC}] Set Admin IP VPS"
echo ""
echo -e "\033[0;34m------------------------------------------\033[0m"
echo ""
