...
echo -e "${RED}❌ Torrent (p2p, streaming p2p)"
echo -e "${RED}❌ PS4"
echo -e "${RED}❌ Porn"
echo -e "${RED}❌ Spam Bug"
echo -e "${RED}❌ Ddos Server"
echo -e "${RED}❌ Mining Bitcoins"
echo -e "${RED}❌ Abuse Usage"
echo -e "${RED}❌ Multi-Login ID"
echo -e "${RED}❌ Sharing Premium Config\e[m"
echo -e "\e[$line═════════════════════════════════\e[m"
...
echo -e "\\E[0;44;37m    ⇱ XRAY Trojan Tcp Tls User Login  ⇲   ${NC}"
echo -e "\033[0;34m══════════════════════════════════════════\033[0m"
for akun in "${data[@]}"
do
if [[ -z "$akun" ]]; then
...
echo -e "\033[0;34m══════════════════════════════════════════\033[0m"
echo -e "\\E[0;44;37m      ⇱ XRAY Trojan WS User Login  ⇲      ${NC}"
echo -e "\033[0;34m══════════════════════════════════════════\033[0m"
for akun in "${data[@]}"
do
if [[ -z "$akun" ]]; then
