...
echo -e " \\E[0;41;36m                DNS CHANGER                 ${NC}"
echo -e "\033[0;34m╘════════════════════════════════════════════╛\033[0m"
echo "DNS Changer"
echo -e ""
echo -e "   ${GREEN} Active DNS : $dns \033[0m"
echo -e ""
echo -e " [\e[36m•1 ${NC}] INPUT DNS TEMPORARY.REBOOT VPS FOR RETURN TO INITIAL DNS"
echo -e " [\e[36m•2 ${NC}] INPUT DNS PERMANENTLY"
echo -e " [\e[36m•3 ${NC}] BACK TO MAIN MENU"
echo -e ""
