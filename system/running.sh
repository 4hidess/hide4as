...
echo -e "$NC"
rm -f /usr/bin/user
export username=$( curl -sS https://raw.githubusercontent.com/4hidess/allow/main/ipvps.conf | grep $MYIP | awk '{print $2}' )
echo "$username" > /usr/bin/user

# // ORDER ID
rm -f /usr/bin/ver
export user=$( curl -sS https://raw.githubusercontent.com/4hidess/allow/main/ipvps.conf | grep $MYIP | awk '{print $3}' )
echo "$user" > /usr/bin/ver

# // VALIDITY
rm -f /usr/bin/e
export valid=$( curl -sS https://raw.githubusercontent.com/4hidess/allow/main/ipvps.conf | grep $MYIP | awk '{print $4}' )
...
echo -e "Time        : $jam ( WIB )"
echo "-----------------------------------------------------------"
echo -e "${GREEN}STATUS SCRIPT :${NC}"
echo -e "\e[0;34mUser        :${NC} $username"
echo -e "\e[0;34mOrder ID    :${NC} $oid"
echo -e "\e[0;34mExpired     :${NC} $exp"
echo "-----------------------------------------------------------"
echo -e ""
echo -e "              ${GREEN}[\e[1;36mSYSTEM STATUS INFORMATION${GREEN}]${NC}"
echo -e "             \e[0;34m=============================${NC}"
echo -e ""
echo -e "\e[1;33mSTATUS SSH & OPEN VPN:${NC}"
echo -e "\e[0;34m-----------------------${NC}"
...
echo -e ""
echo -e "\e[1;33mSTATUS NGINX & SQUID:${NC}"
echo -e "\e[0;34m--------------------${NC}"
