...
echo -e "\e[1;36m.-----------------------------------------.${NC}"
echo -e "\e[1;36m|            \e[1;33mCHANGE PORT OPENVPN\e[m          \e[1;36m|${NC}"
echo -e "\e[1;36m'-----------------------------------------'${NC}"
echo -e " ${GREEN}>>${NC}\e[1;35mChange Port For OpenVPN:${NC}"
...
echo -e "${RED}Port $vpn is used${NC}"
fi
;;
2)
read -p "New Port OpenVPN: " vpn
...
echo -e "${RED}Port OHP OpenVPN $vpn is used${NC}"
fi
;;
4)
...
echo -e "${RED}Port OpenVPN SSL $vpn is used${NC}"
fi
;;
x)
clear
