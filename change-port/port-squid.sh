...
echo -e "\e[0;31m.-----------------------------------------.${NC}"
echo -e "\e[0;31m|             \e[0;36mCHANGE PORT SQUID\e[m           \e[0;31m|${NC}"
echo -e "\e[0;31m'-----------------------------------------'${NC}"
echo -e " ${RED}>>${NC}\e[0;34mChange Port For Squid:${NC}"
...
echo -e "\e[032;1mPort $squid modified successfully${NC}"
else
echo -e "${RED}Port $squid is used${NC}"
fi
;;
2)
read -p "New Port Squid: " squid
