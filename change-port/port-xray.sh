...
clear
echo -e "\e[0;34m.-----------------------------------------.${NC}"
echo -e "\e[0;34m|             \e[1;33mCHANGE PORT XRAY\e[m            \e[0;34m|${NC}"
echo -e "\e[0;34m'-----------------------------------------'${NC}"
echo -e " ${RED}>>${NC}${GREEN}Change Port For Xray :${NC}"
...
clear
echo -e "\e[032;1mPort $tls1 modified successfully${NC}"
else
echo -e "${RED}Port $tls1 is used${NC}"
fi
;;
2)
...
clear
echo -e "\e[032;1mPort $none1 modified successfully${NC}"
else
echo -e "${RED}Port $none1 is used${NC}"
fi
;;
x)
clear
